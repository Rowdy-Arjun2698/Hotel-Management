...
import { ChevronDown, Check, Edit2, Plus, X, Upload } from "lucide-react";
    ...
    <div className={`relative group ${width}`} ref={rootRef}>
      <button
        ...
        className={`w-full h-12 rounded-full bg-gray-100 pl-5 pr-10 outline-none
                    ...
                    ${open ? "bg-white ring-2 ring-indigo-300 shadow-sm" : ""}`}
      >
...
const EditDish = ({ onClose, onSuccess, categories, editeddish }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(
        `http://localhost:3000/api/menu/update_dish/${editeddish._id}`,
        payload,
        {
  ...
  //...................................................
  useEffect(() => {
    if (!editeddish || !editeddish.categoryId) return;

    setDishName(editeddish.dishName);
    setDescription(editeddish.description);
    setFoodType(editeddish.foodType);
    setIsAvailable(editeddish.isAvailable);
    setVariants(editeddish.variants);

    setMainCategory(editeddish.categoryId.mainCategory);
    setCategoryName(editeddish.categoryId.Catname);
    setCategoryId(editeddish.categoryId._id);

    setImage(null);
    setImagePreview(`http://localhost:3000${editeddish.image}`);
  }, [editeddish]);
  //...................................................
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="w-[560px] max-h-[90vh] overflow-y-auto bg-white rounded-2xl shadow-2xl p-8 border-2 border-indigo-100 [animation:dishSlideUp_0.2s_ease-out]"
      >
          ...
          <div className="space-y-5">
            ...
            <div>
              ...
              <div
                ...
                className="w-full h-36 rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50
                           hover:bg-gray-100 hover:border-indigo-300 transition-all duration-150
            ...
            <div>
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-lg p-3 outline-none transition-all duration-150 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200"
                required
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full border border-gray-200 rounded-lg p-3 outline-none resize-none transition-all duration-150 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200"
              />
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <button
                  type="button"
                  onClick={addVariant}
                  className="flex items-center gap-1 text-sm text-indigo-500 hover:text-indigo-600 font-medium cursor-pointer"
                >
                  <Plus size={16} /> Add
                </button>
              </div>
                ...
                {variants.map((variant, index) => (
                  <div key={index} className="flex items-center gap-2">
                    <input
                      ...
                      className="flex-1 border border-gray-200 rounded-lg p-2.5 text-sm outline-none transition-all duration-150 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200"
                      required
                    />
                    <input
                      type="number"
                      ...
                      className="w-28 border border-gray-200 rounded-lg p-2.5 text-sm outline-none transition-all duration-150 focus:border-indigo-400 focus:ring-2 focus:ring-indigo-200"
                      required
                    />
                    {variants.length > 1 && (
                      <button
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <span className={`text-xs transition-colors duration-200 ${isAvailable ? "text-indigo-500" : "text-gray-400"}`}>
              ...
              >
                ...
                >
                  {isAvailable ? (
                    <Check size={13} className="text-indigo-500" strokeWidth={3} />
                  ) : (
